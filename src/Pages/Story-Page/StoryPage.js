    ...
    <div className="container-story-page">
      ...
      <div className="container-story-text">
        <p>
          ...
          at a reasonable price without compromising on quality. The protype was
          so successful that while out on training rides people wanted to know
          more about the bike and wheels and where they could purchase them.
          After refining the protypes and getting the wheels tested and approved
          by the UCI NR6 was launched.
        </p>
        <p>
